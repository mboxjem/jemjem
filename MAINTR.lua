...
function A1()
  player = gg.multiChoice({
    ...
    "3.\240\159\147\130 Antena (90% safe)(Landed)",
...
function AT1()
  local file = gg.makeRequest("https://raw.githubusercontent.com/mboxjem/jemjem/master/AT1.lua")
  local load =
  load(file.content)
  if load == nil then
  os.exit()
...
function AT2()
  local file = gg.makeRequest("https://raw.githubusercontent.com/mboxjem/jemjem/master/AT2.lua")
  local load =
  load(file.content)
  if load == nil then
  os.exit()
